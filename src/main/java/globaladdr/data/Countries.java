...
import globaladdr.data.locales.LocalesAU;
import globaladdr.data.locales.LocalesBR;
import globaladdr.data.locales.LocalesCA;
import globaladdr.data.locales.LocalesCC;
import globaladdr.data.locales.LocalesCX;
import globaladdr.data.locales.LocalesGB;
import globaladdr.data.locales.LocalesHN;
import globaladdr.data.locales.LocalesIQ;
import globaladdr.data.locales.LocalesIT;
import globaladdr.data.locales.LocalesJM;
import globaladdr.data.locales.LocalesMX;
import globaladdr.data.locales.LocalesSO;
import globaladdr.data.locales.LocalesSR;
import globaladdr.data.locales.LocalesUS;
import globaladdr.data.locales.LocalesUY;
import globaladdr.data.locales.LocalesVE;
import globaladdr.data.locales.LocalesYE;
import globaladdr.data.locales.LocalesZW;
...
public class Countries {
    ...
    private static Map<String, Country> initializeMap() {
        ...
        addCountry(list, layouts, new Country("GB","UNITED KINGDOM","UNITED KINGDOM",TOWN,null,"EC1Y 8SY","(([A-Z]{1,2})([0-9]{1,2}[A-Z]?[ ])(\\d[A-Z]{2}))|GIR[ ]0AA","44",false,0, new LocalesGB(), null));
        addCountry(list, layouts, new Country("US","UNITED STATES","UNITED STATES OF AMERICA",CITY,STAT,"59601-4901","\\d{5}[- ]?(\\d{4})?",null,true,-5, new LocalesUS(), null));
        addCountry(list, layouts, new Country("UY","URUGUAY","URUGUAY",CLCL,DEPT,"11600","\\d{5}","598",true,-3, new LocalesUY(), null));
        ...
        addCountry(list, layouts, new Country("VE","VENEZUELA","VENEZUELA",CLCL,STAT,"1010","\\d{4}","58",true,-4, new LocalesVE(), null));
        ...
        addCountry(list, layouts, new Country("YE","YEMEN","YEMEN",CLCL,GVRT,null,null,"967",true,3, new LocalesYE(), null));
        addCountry(list, layouts, new Country("ZW","ZIMBABWE","ZIMBABWE",CLCL,PROV,null,null,"263",true,2, new LocalesZW(), null));
        ...
        addCountry(list, layouts, new Country("SO","SOMALIA","SOMALIA",TOWN,REGN,"JH 09010","([A-Z]{02}[ ]\\d{5})","252",true,3, new LocalesSO(), null));
        ...
        addCountry(list, layouts, new Country("SR","SURINAME","SURINAME",CDSR,null,null,null,"597",true,-3, new LocalesSR(), null));
        ...
        addCountry(list, layouts, new Country("AU","AUSTRALIA","AUSTRALIA",CITY,STAT,"2060","\\d{4}","61",true,10, new LocalesAU(), null));
        ...
        addCountry(list, layouts, new Country("BR","BRAZIL","BRAZIL",TOWN,STAT,"40301-110","\\d{5}-\\d{3}","55",true,-3, new LocalesBR(), null));
        ...
        addCountry(list, layouts, new Country("CA","CANADA","CANADA",CITY,PROV,"H3Z 2Y7","[A-Z]\\d[A-Z][ ]\\d[A-Z]\\d",null,true,-4, new LocalesCA(), null));
        ...
        addCountry(list, layouts, new Country("CX","CHRISTMAS ISLAND","AUSTRALIA",CITY,STAT,"2060","\\d{4}","61",true,-10, new LocalesCX(), null));
        addCountry(list, layouts, new Country("CC","COCOS (KEELING) ISLANDS","AUSTRALIA",CITY,STAT,"2060","\\d{4}","61",true,-10, new LocalesCC(), null));
        ...
        addCountry(list, layouts, new Country("HN","HONDURAS","HONDURAS",CLCL,DEPT,"CM1102","[A-Z]{2}\\d{4}","504",true,-6, new LocalesHN(), null));
        ...
        addCountry(list, layouts, new Country("IQ","IRAQ","IRAQ",CLCL,PROV,"61002","\\d{5}","964",true,3, new LocalesIQ(), null));
        ...
        addCountry(list, layouts, new Country("IT","ITALY","ITALY",CLCL,PROV,"00144","\\d{5}","39",true,1, new LocalesIT(), null));
        addCountry(list, layouts, new Country("JM","JAMAICA","JAMAICA",TOWN,PRSH,"10",".*",null,true,-5, new LocalesJM(), null));
        ...
        addCountry(list, layouts, new Country("MX","MEXICO","MEXICO",CLCL,PROV,"02860","\\d{5}","52",true,-6, new LocalesMX(), null));
